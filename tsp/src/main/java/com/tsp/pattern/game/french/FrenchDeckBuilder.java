...
public class FrenchDeckBuilder {
	...
	private FrenchSuit[] suits = { FrenchSuit.CUORI, FrenchSuit.FIORI
			// , FrenchSuit.PICCHE, FrenchSuit.QUADRI
	};
	private Value[] values = { Value.ASSO, Value.CAVALLO, Value.CINQUE, Value.DUE, Value.FANTE
			// , Value.QUATTRO, Value.RE,
